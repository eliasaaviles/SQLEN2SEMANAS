--2
 ...
 insert into agenda (nombre,apellido, domicilio, telefono)
  values ('Elias','Alejandro','Silencio II','8092441256');
 insert into agenda (nombre,apellido, domicilio, telefono)
  values ('Luis','Jose','Ramos','1118889999');
...
create database peliculas;
 ...
 insert into peliculas (nombre, actor, duracion, cantidad)
  values ('avengers 1','Elias',146,6);
 insert into peliculas (nombre, actor, duracion, cantidad)
  values ('avengers 2','Elias',68,4);
 insert into peliculas (nombre, actor, duracion, cantidad)
  values ('Spiderman','Elias',83,9);
 insert into peliculas (nombre, actor, duracion, cantidad)
  values ('Thor','Elias',70,8);
 ...
 insert into agenda(nombre,apellido,domicilio,telefono) values
  ('heline', 'angeles', 'silencio 2', '6548');

 insert into agenda(nombre,apellido,domicilio,telefono) values
  ('arlene', 'maria', 'Indiana veronica', '5886');

 insert into agenda(nombre,apellido,domicilio,telefono) values
  ('viejo', 'de botar', 'Saledo', '2135658'); 
 insert into agenda(nombre,apellido,domicilio,telefono) values
  ('nuevo', 'de caja', 'sdfsdf226', '86518');
 insert into agenda(nombre,apellido,domicilio,telefono) values
  ('medio', 'jove', 'orqudea', '32158');

 select *from agenda;

 select *from agenda
  where nombre='hola Adios';

 select nombre,domicilio from agenda
  where apellido='Aviles';

 select nombre from agenda
  where telefono='825168';
 ...
 insert into articulos (codigo, nombre, descripcion, precio,cantidad)
  values (1,'dell','inspiron 15',20000,88);
 insert into articulos (codigo, nombre, descripcion, precio,cantidad)
  values (2,'teclado','dell',200,50);
 insert into articulos (codigo, nombre, descripcion, precio,cantidad)
  values (3,'mouse','dell',150,50);
 insert into articulos (codigo, nombre, descripcion, precio,cantidad)
  values (4,'monitor','dell 15"',2000,20);
 insert into articulos (codigo, nombre, descripcion, precio,cantidad)
  values (5,'mesa','escritorio p/pc',2300,10);
 ...
 update agenda set nombre='Elias Alejandro'
  where nombre='Juan';

 select * from agenda;

 update agenda set telefono='8092441256'
  where telefono='4545454';
...
-- sp_helpconstraint vehiculos;
 ...
 -- RG_vehiculos_tipo, 'vehiculos.tipo';
 ...
 --RG_vehiculos_tipo2, 'vehiculos.tipo';
